                    ...
                    <div class="menu-item">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <button class="add-to-cart" 
                                    onclick="addToCart('${item.name?.replace(/'/g, "\\'")}', ${item.price || 0}, '${restaurant.name?.replace(/'/g, "\\'")}', '${restaurant.name}-${index}', this)">
                                Add to Cart
                            </button>
                        </div>
                    </div>
                `).join('') || '<div class="menu-item"><div class="item-name">No menu items available</div></div>'}
            </div>
        </div>
    `).join('');
}
